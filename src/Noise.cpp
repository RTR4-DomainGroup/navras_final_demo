...
GLuint CreateNoise3D()
{
	...
	// code
	make3DNoiseTexture();
	GLuint internalNoiseTextureID = init3DNoiseTexture(Noise3DTexSize, Noise3DTexPtr);
	return internalNoiseTextureID;
}
...
void uninitializeNoiseTexture(void)
{
	// code
	if (noiseTextureID)
	{
